    ...
    jQuery.fn.yiiUploadKit = function (options) {
        ...
        var methods = {
            init: function () {
                ...
                var addBtn = '';
                if(options.editable){
                    addBtn = '<li class="upload-kit-input"></div>';
                }else{
                    addBtn = '<li class="upload-kit-input d-none"></div>';
                }
                $input.wrapAll($(addBtn))
            ...
            createItem: function (file) {
                ...
                item.append($('<span/>', {"class": "fas fa-arrow-circle-down download", "data-url": '/attachement/default/download?id='+file.attachment_id}));
